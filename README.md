...
Therefore there are infinitely many NE if both $x1 = x3$ and $x2 = x4$, or both $y1 = y2$ and $y3 = y4$. This follows from the fact that there exists at least one NE for our game. From this one NE we can generate infinitely many more NE by mixing over the interval $[0,1]$.
